...
export async function PATCH(request: NextRequest) {
  ...
  try {
    ...
    // Forensic method derives from lookup branch, not client body alone.
    // Client may hint qr_scan, but default to manual_search unless QR payload matches.
    const method = body.method === "qr_scan" ? "qr_scan" : "manual_search";
