    ...
    <div className="max-w-3xl mx-auto px-4 py-8 space-y-6">
      ...
      <Card>
        ...
        <CardContent className="space-y-6">
          ...
          {/* Bio */}
          <div className="space-y-2">
            <label htmlFor="profile-bio" className="text-sm font-medium text-muted">Bio</label>
            {isEditing ? (
              <TextArea
                id="profile-bio"
                value={editForm.bio}
          ...
          {/* Interests */}
          <div className="space-y-2">
            <h3 className="text-sm font-medium text-muted">Interests</h3>
            {isEditing ? (
              <div className="space-y-2">
                <div className="flex gap-2">
                  <Input
      ...
      <Card>
        ...
        <CardContent className="space-y-6">
          {/* Membership */}
          <div className="space-y-2">
            <h3 className="text-sm font-medium text-muted">Membership</h3>
            {membership ? (
          ...
          {/* Departments */}
          <div className="space-y-2">
            <h3 className="text-sm font-medium text-muted">Departments</h3>
            <div className="flex flex-wrap gap-2">
          ...
          {/* Designations */}
          <div className="space-y-2">
            <h3 className="text-sm font-medium text-muted">Designations</h3>
            <div className="flex flex-wrap gap-2">
