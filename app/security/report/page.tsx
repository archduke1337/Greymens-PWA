...
export default function SecurityReportPage() {
  ...
  const submitActivity = async (event: React.FormEvent) => {
    ...
    try {
      ...
      setActivityError(
        "Could not submit the activity request. Please try again.",
      );
    } finally {
      ...
      <header className="grid items-center gap-6 sm:grid-cols-[1fr_180px]">
        <div className="space-y-3">
          ...
          <p className="max-w-2xl text-[15px] leading-relaxed text-[var(--muted)]">
            ...
            say something here. Non-security complaints (conduct, disputes) go
            through{" "}
            <a
      ...
      <div className="grid gap-6 lg:grid-cols-2">
        <Card>
          <CardHeader className="flex-row items-center gap-3">
            ...
            <h2 className="text-xl font-bold">Request authorized activity</h2>
          </CardHeader>
          <CardContent>
            <Form
              className="space-y-4"
            ...
            >
              ...
              <TextField
                ...
                name="title"
                validate={(value) =>
                  value.trim() ? null : "Name the activity"
                }
              ...
              <TextField
                ...
                name="description"
                validate={(value) =>
                  value.trim() ? null : "Describe the activity"
                }
              ...
              >
                ...
                <TextArea
                  placeholder="Methods, tools, expected outcome"
                  rows={3}
                />
                <FieldError />
              </TextField>
              ...
              >
                ...
                <TextArea placeholder="In scope, out of scope" rows={3} />
                <FieldError />
              </TextField>
              <TextField
                isDisabled={activityLoading}
                ...
                onChange={(value) =>
                  setActivity({ ...activity, techniques: value })
                }
              >
                <Label>Techniques</Label>
                <Input placeholder="Comma-separated" />
                <Description>
                  Optional. Helps reviewers size the risk.
                </Description>
              </TextField>
              <TextField
                isRequired
                ...
                name="dataBoundary"
                validate={(value) =>
                  value.trim() ? null : "State the data boundary"
                }
                value={activity.dataBoundary}
                onChange={(value) =>
                  setActivity({ ...activity, dataBoundary: value })
                }
              >
                <Label>Data boundary</Label>
                <TextArea
                  placeholder="What data will you touch, store, or see?"
                  rows={3}
                />
                <FieldError />
              </TextField>
              <TextField
                ...
                name="purpose"
                validate={(value) =>
                  value.trim() ? null : "State the purpose"
                }
                value={activity.purpose}
                onChange={(value) =>
                  setActivity({ ...activity, purpose: value })
                }
              >
                <Label>Purpose</Label>
                <TextArea
                  placeholder="Why is this worth authorizing?"
                  rows={3}
                />
                <FieldError />
              </TextField>
              <div className="grid gap-4 sm:grid-cols-2">
                <TextField
                  ...
                  onChange={(value) =>
                    setActivity({ ...activity, startsAt: value })
                  }
                >
                  <Label>Starts</Label>
                ...
                <TextField
                  ...
                  onChange={(value) =>
                    setActivity({ ...activity, endsAt: value })
                  }
                >
                  <Label>Ends</Label>
                  <Input type="datetime-local" />
          ...
          <CardContent>
            ...
            >
              <p className="text-sm text-[var(--muted)]">
                Use this for suspected compromise, unauthorized access,
                credential exposure, data loss, or unsafe activity — including
                misconduct that affects safety. Do not investigate beyond your
                authorization.
              </p>
              {incidentError && (
                <Alert role="alert" status="danger">
              ...
              <TextField
                ...
                name="title"
                validate={(value) =>
                  value.trim() ? null : "Give the incident a title"
                }
              ...
              <TextField
                ...
                name="description"
                validate={(value) =>
                  value.trim() ? null : "Describe what happened"
                }
                value={incident.description}
                onChange={(value) =>
                  setIncident({ ...incident, description: value })
                }
              >
                <Label>What happened?</Label>
                <TextArea
                  placeholder="What you saw, when, and where — facts first"
                  rows={4}
                />
                <FieldError />
              </TextField>
              <TextField
                ...
                validate={(value) =>
                  value.trim() ? null : "Name the affected resource"
                }
                value={incident.affectedResource}
                onChange={(value) =>
                  setIncident({ ...incident, affectedResource: value })
                }
              >
                ...
                >
                  ...
                  <Select.Popover>
                    <ListBox>
                      ...
                      <ListBox.Item id="moderate" textValue="Moderate">
                        Moderate
                        <ListBox.ItemIndicator />
                      </ListBox.Item>
                      <ListBox.Item id="major" textValue="Major">
                        Major
                        <ListBox.ItemIndicator />
                      </ListBox.Item>
